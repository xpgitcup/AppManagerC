...
<html>
	...
	<body>
		...
		<div id="edit-appRoles" class="content scaffold-edit" role="main">
			...
			<g:hasErrors bean="${appRolesInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${appRolesInstance}" var="error">
				<li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
				</g:eachError>
			</ul>
			</g:hasErrors>
			<g:form url="[resource:appRolesInstance, action:'update']" method="PUT" >
				<g:hiddenField name="version" value="${appRolesInstance?.version}" />
				<fieldset class="form">
